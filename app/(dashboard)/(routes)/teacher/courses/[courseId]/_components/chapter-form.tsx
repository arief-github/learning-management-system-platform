...
export const ChapterForm = ({ initialData, courseId } : ChapterFormProps) => {
    ...
    return (
        <div className="relative flex flex-col gap-4">
            {
                isUpdating ? (
                    <div className="absolute h-full w-full inset-0 bg-slate-500/20 top-0 right-0 rounded-m flex items-center justify-center">
                ...
                isCreating ? (
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
                            ...
                            />
                            <ButtonSubmit isSubmitting={isSubmitting} isValid={isValid} buttonText="Create" />
                        </form>
                    </Form>        
                ) : null
            }
